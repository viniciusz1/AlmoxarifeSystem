...
export class ConferenciaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(this.entregas == 1){
     this.pedidos.getPedidobyCodigo(parseInt(this.id))
      .subscribe({next: (e) => {
        console.log(e)
        this.pedido = e
      }})    
